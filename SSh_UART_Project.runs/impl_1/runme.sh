...
HD_PWD='C:/Users/ursus/SSh_UART_Project/SSh_UART_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SS_LR_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SS_LR_TOP.tcl -notrace
